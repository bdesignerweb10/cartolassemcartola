						...
						<div id="box-ano" class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-box">
							...
							<div class="row">			  			
					  			<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
					  				<img src="img/escudos/clube/<?php echo $_SESSION["usu_escudo"]; ?>" class="img-fit">	
					  			</div>
					  			<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9">		    			
									<label for="brasao">Brasão</label>
					    			<input id="brasao" name="brasao" type="file" aria-describedby="brasao" class="form-control form-control-lg">
							...
							<div class="row">
					  			<div class="col-12">
								    ...
								    <textarea class="form-control form-control-lg" id="historia" name="historia" rows="6" placeholder="Esse clube é muito pequeno, e por isso não tem história. Tá na hora de ganhar alguma coisa né, parça?" data-error="Por favor, informe a história do clube."><?php echo $historia; ?></textarea>
					    			<div class="help-block with-errors"></div>
					    		</div>
							</div>				

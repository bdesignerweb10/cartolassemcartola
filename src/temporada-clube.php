	...
	<div class="container">
		<div class="row resumo-temporada-clube">
			<div class="col-sm-4 offset-1 temp-esc-clube">	
				...
				<h3 class="temp-nome">Palestrino 84 FC</h3>				
			</div>
			<div class="col-sm-3">
				<h3 class="temp-result">2183.93<span>pts</span></h3>
				<p class="temp-info">Na temporada</p>
			</div>
			<div class="col-sm-3 offset-1">
				<h3 class="temp-result">85.93<span>média</span></h3>
				<p class="temp-info">Na temporada</p>
			</div>
		</div><!-- row -->
		...
		<div class="row resumo-temporada"> 
			<div class="col-sm-2 offset-1 card-temporada-clube">
				...
				<h3 class="resumo-detalhado">138.96</h3>
			...
			<div class="col-sm-2 offset-1 card-temporada-clube">
				...
				<h3 class="resumo-detalhado">138.96</h3>
				<p class="temp-info-detalhado">Maior pontuação <br />26º Rodada</p>
			</div>
			<div class="col-sm-2">
				<img src="img/fimtemporada/menor-pontuacao.png" class="temp-img">
				<h3 class="resumo-detalhado">138.96</h3>
				<p class="temp-info-detalhado">Menor pontuação <br />26º Rodada</p>
			</div>
			<div class="col-sm-2">
				<img src="img/fimtemporada/cartoletas.png" class="temp-img">
				<h3 class="resumo-detalhado">C$138.96</h3>

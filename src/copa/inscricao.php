...
<main class="inscmain">
	<div class="container">
		...
		<div class="row ">
			<div class="col-sm-12">
				<h3 class="headline">Inscrição Bolão Copa 2018</h3>
				<div class="inscricao">
					<form id="form-inscricao" data-toggle="validator" action="" method="POST">			  			
			  			<div class="row" style="margin-bottom: 1rem;">
			  				<div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
								<input type="text" class="form-control" id="nome" name="nome" aria-describedby="nome" placeholder="Informe seu nome" data-error="Insira seu nome." maxlength="120" required>
						...
						<div class="form-check" style="justify-content: left; margin-bottom: 10px;">
							...
							<input type="checkbox" class="form-check-input" id="regulamento" name="regulamento">
			    				&nbsp; Eu declaro que li e aceito o regulamento do bolão da Copa do Mundo
							</label>
			    			<div class="help-block with-errors"></div>
						</div>
	  					<button id="btn-inscricao" type="submit" class="btn btn-primary form-control" name="submit" disabled>Iniciar Palpites</button>		
					</form>
				</div>
			</div><!-- col-sm-12-->	
		</div><!-- row -->

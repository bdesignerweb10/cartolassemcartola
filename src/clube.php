...
<main>
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
				<ul class="escudos">
					<li><img src="img/escudos/Hasdrubal-FC.png" class="img-fluid"></li>
					<li><img src="img/escudos/BierFortes.png" class="img-fluid"></li>
					<li><img src="img/escudos/Boleanos-FC.png" class="img-fluid"></li>
					<li><img src="img/escudos/Palestrino.png" class="img-fluid"></li>
					<li><img src="img/escudos/Hasdrubal-FC.png" class="img-fluid"></li>
					<li><img src="img/escudos/BierFortes.png" class="img-fluid"></li>
					<li><img src="img/escudos/Boleanos-FC.png" class="img-fluid"></li>
					<li><img src="img/escudos/Palestrino.png" class="img-fluid"></li>
		...
		<div class="row cont-clube">
			<div class="col-sm-6">
				<h3 class="tit-clube">Galeria de títulos / Desempenho</h3>
			</div>	

...
function enviarEmail($forma_pagto, $nome, $email, $valor) {
	...
	try {
	    ...
	    $mail->isHTML(true);
	    $mail->Subject = utf8_decode("[Liga Cartoleirão - Trabalho Seguro TS] Sua pré-inscrição na liga, fera!");
	    $mail->Body    = utf8_decode("<html><head></head><body><table width='600' border='0' align='center' cellpadding='0' cellspacing='0' style='background-color:#e9e9e9;'><tr><td style='background-color:#fc8f3e; width:600px; height:106px;'><h3 style='font-family:Verdana, Geneva, sans-serif; color:#fff; padding-top:15px;' align='center'>Inscrição Liga Cartoleirão - Trabalho Seguro TS</h3></td></tr><tr><td><p style='font-family:Verdana, Geneva, sans-serif; padding-left:20px; padding-top:20px;'>Olá cartoleiro " . $nome . "!</p><p style='font-family:Verdana, Geneva, sans-serif; padding-left:20px;'>Já recebemos seu pedido de inscrição, efetuando o pagamento a sua inscrição será validada. Tira o escorpião do bolso logo, parça!</p>" . $msg_html . "<p style='font-family:Verdana, Geneva, sans-serif; padding-left:20px;'>Caso tenha alguma dúvida ou sugestão, entre em contato por:</p><p style='font-family:Verdana, Geneva, sans-serif; padding-left:20px;'> - (19) 99897-0090<br /> - <a href='mailto:contato@cartolassemcartola.com.br'>contato@cartolassemcartola.com.br</a></p><p style='font-family:Verdana, Geneva, sans-serif; padding-left:20px; padding-bottom:20px;'>Att,</p></td></tr><tr><td style='background-color:#fc8f3e; width:600px; height:106px;'><h3 style='font-family:Verdana, Geneva, sans-serif; color:#fff; padding-top:15px;' align='center'>Equipe Cartoleirão - Trabalho Seguro TS</h3></td></tr></table></body></html>");
	    $mail->AltBody = utf8_decode("Olá cartoleiro " . $nome . "! Já recebemos sua inscrição, efetuando o pagamento sua inscrição será validada. " . $msg_plain . " | Caso tenha alguma dúvida ou sugestão, entre em contato por: (19) 99897-0090 ou contato@cartoleirao.com.br. Att., Equipe 
	     Cartoleirão - Trabalho Seguro TS.");

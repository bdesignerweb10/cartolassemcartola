		...
		<div class="row justify-content-md-center">
			<div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 login-box">
				<div class="login-header">
					...
					<span class="head-login">Painel Liga Cartoleirão</span>
				</div>
				<form id="form-login" data-toggle="validator" action="acts/acts.login.php" method="POST">
		  			<div class="form-group">		    			
						<label for="login">Usuário</label>
		    			<input type="text" class="form-control form-control-lg" id="login" name="login" aria-describedby="login" placeholder="Digite seu usuário..." data-error="Por favor, informe o login." maxlength="120" required>

...
<main class="maintable">
	<div class="container">
		<h3 class="headline">Gerenciamento de temporadas</h3>
		<div class="row" style="margin-bottom: 20px;">
			<div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 offset-md-6 offset-lg-8 offset-lg-8">
				<button type="button" class="btn btn-success btn-lg form-control" id="btn-add-temporadas">
					<i class='fa fa-plus'></i> Nova temporada
				</button>		
			</div><!-- col-sm-8-->
		</div><!-- row -->	
		<div class="row">
	...
	<div class="container">
		...
		<div class="row" style="margin-bottom: 10px;">
			<div class="col-sm-12 col-md-6 col-lg-2 col-xl-2">
				<button type="button" id="btn-voltar-temporadas" class="btn btn-link btn-lg form-control btn-voltar">
		...
		<form id="form-temporadas" data-toggle="validator" action="acts/acts.temporadas.php" method="POST">
			<div class="row justify-content-md-center">
				...
				<div id="box-rodada" class="col-sm-12 col-md-10 col-lg-4 col-xl-4 form-box" disabled>
					<h3 class="headline headline-form">Selecione as rodadas!</h3>
					<button type="button" class="btn btn-link form-control btn-voltar" id="voltar-ano">
						<i class='fa fa-arrow-left'></i> Voltar
					</button>	
					<div id="sel-content" class="row" style="margin-bottom: 20px;"></div>
  					<button type="button" class="btn btn-primary btn-lg form-control" id="passo-rodada">
  						<i class='fa fa-arrow-right'></i> Finalizar criação
  					</button>
				</div><!-- col-sm-8--> 
				<div id="box-confirmacao" class="col-sm-12 col-md-10 col-lg-4 col-xl-4 form-box" disabled>
					<h3 class="headline headline-form">Confirme os dados:</h3>
					<button type="button" class="btn btn-link form-control btn-voltar" id="voltar-rodada">
						<i class='fa fa-arrow-left'></i> Voltar
					</button>
					<div class="jumbotron">
						<h3 style="font-weight: 300;" id="resumo-temporada"></h3>
						<hr class="my-4">

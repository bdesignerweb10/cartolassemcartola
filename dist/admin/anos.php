...
<main class="maintable">
	<div class="container">
		<h3 class="headline">Gerenciamento de anos (de temporadas)</h3>
		<div class="row" style="margin-bottom: 20px;">
			<div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 offset-md-6 offset-lg-8 offset-lg-8">
				<button type="button" class="btn btn-success btn-lg form-control btn-add" name="btn-add" data-div-hide="maintable" data-div-show="mainform">
					<i class='fa fa-plus'></i> Cadastrar novo ano
				</button>		
			</div><!-- col-sm-8-->
		</div><!-- row -->	
		<div class="row">
			        	...
			        	while($dados = $anos->fetch_object()) {
			        		if($dados->id == $_SESSION["temporada_atual"]) {
				        		...
				        		echo "<tr>
						                ...
						                <td class='center'>&nbsp;</td>
						                <td class='center'>
						                	<a href='#' class='btn-edit' data-alt-id='$dados->id' data-page='anos'>
						                		<i class='fa fa-edit fa-2x edit'></i>
					                		</a>
						                	<a href='#' class='btn-del' data-alt-id='$dados->id' data-page='anos'>

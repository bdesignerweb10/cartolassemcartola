...
<main class="maintable">
	<div class="container">
		<h3 class="headline">Gerenciamento de usuários</h3>
		<?php if($_SESSION["usu_nivel"] == 1) : ?>
			<div class="row" style="margin-bottom: 20px;">
				<div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 offset-md-6 offset-lg-8 offset-lg-8">
					<button type="button" class="btn btn-success btn-lg form-control" id="btn-add-usuarios">
						<i class='fa fa-plus'></i> Novo usuário administrador
					</button>		
				</div><!-- col-sm-8-->
			</div><!-- row -->	
		<?php endif; ?>
...
<main class="mainadd">
	<div class="container">
		<div class="row" style="margin-bottom: 10px;">
			<div class="col-sm-12">
				<h3 class="headline" id="headline-add-usuarios"></h3>
			</div><!-- col-sm-8-->
		</div><!-- row -->	
		<div class="row" style="margin-bottom: 10px;">
			<div class="col-sm-12 col-md-6 col-lg-2 col-xl-2">
				<button type="button" class="btn btn-link btn-lg form-control btn-voltar btn-voltar-usuarios">
					<i class='fa fa-arrow-left'></i>&nbsp;&nbsp;&nbsp;Voltar
				</button>	
			</div><!-- col-sm-8-->
		</div><!-- row -->	
		<div class="row justify-content-md-center">
			<div id="box-ano" class="col-sm-12 col-md-9 col-lg-6 col-xl-6 form-box">
				<form id="form-usuarios-add" data-toggle="validator" action="acts/acts.usuarios.php" method="POST">
					<h3 class="headline headline-form-add"></h3> 
					<div class="row">
			  			<div class="col-12">		    			
							<label for="usuario">Usuário admin</label>
			    			<input type="text" class="form-control form-control-lg" id="usuario" name="usuario" aria-describedby="usuario" placeholder="Informe o usuário admin..." data-error="Por favor, informe o usuário." maxlength="120" required>
					...
					<div class="row">
			  			<div class="col-12">		    			
			    			...
			    			<input type="password" class="form-control form-control-lg" id="senha" name="senha" aria-describedby="senha" placeholder="Informe a senha..." data-error="Por favor, informe a senha." maxlength="120" required>
			    			<div class="help-block with-errors"></div>
			    		</div>
					</div>
  					<button type="button" class="btn btn-success btn-lg form-control" id="btn-incluir-usuario">
...
<main class="mainform">
	<div class="container">
		<div class="row" style="margin-bottom: 10px;">
			<div class="col-sm-12">
				<h3 class="headline" id="headline-edit-usuarios"></h3>
			</div><!-- col-sm-8-->
		</div><!-- row -->	
		<div class="row" style="margin-bottom: 10px;">
			<div class="col-sm-12 col-md-6 col-lg-2 col-xl-2">
		...
		<div class="row justify-content-md-center">
			<div id="box-ano" class="col-sm-12 col-md-10 col-lg-9 col-xl-9 form-box">
				<form id="form-usuarios-edit" data-toggle="validator" action="acts/acts.usuarios.php" method="POST">
					<h3 class="headline headline-form-edit"></h3> 
					<div class="row">
			  			...
			  			<div class="col-sm-8 col-md-8 col-lg-10 col-xl-10">		    
							...
							<h3 id="time-usuario"></h3>			
			    		</div>
					</div>
					<div class="row">
			  			<div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">		    			
							<label for="user">Usuário</label>
			    			<input type="text" class="form-control form-control-lg" id="user" name="user" aria-describedby="user" placeholder="Informe o usuário..." data-error="Por favor, informe o usuário." maxlength="120" required>
			    			<div class="help-block with-errors"></div>
			    		</div>
			  			<div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">		    			
							<label for="password">Senha</label>
			    			<input type="password" class="form-control form-control-lg" id="password" name="password" aria-describedby="password" placeholder="Informe a senha..." data-error="Por favor, informe a senha." maxlength="120" required>
			    			<div class="help-block with-errors"></div>
			    		</div>
			  			<div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">		    			
							<label for="nivel">Nível</label>
							<select class="form-control form-control-lg" id="nivel" name="nivel" aria-describedby="nivel" placeholder="Selecione o nivel..." data-error="Por favor, selecione o nivel." required>
					...
					<div class="row" style="margin-top: 50px;">
			  			<div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
		  					<button type="button" class="btn btn-success btn-lg form-control" id="btn-editar-usuario">
		  						<i class='fa fa-save'></i> Salvar dados
		  					</button>
			    		</div>
			  			<div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
		  					<button type="button" class="btn btn-warning btn-lg form-control" id="btn-desativar-usuario">
		  						<i class='fa fa-thumbs-down'></i> Desativar usuário
		  					</button>
			    		</div>
					</div>
				</form>

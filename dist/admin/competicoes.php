					...
					<div class="row">
			  			<div class="col-sm-12 col-md-12 col-lg-3 col-xl-3">		    			
							...
							<div class="input-group ">
		    					...
		    					<input type='text' class='form-control form-control-lg' id='valor' name='valor' placeholder='0,00' data-mask='##0,00' data-mask-selectonfocus='true' data-mask-clearifnotmatch='true' data-mask-reverse='true' maxlength='7' />
							</div>
			    		</div>
			  			...
			  			<div class="col-12">
			  				<div class="checkbox">
								<label>
									...
									Se a competição é a principal (Liga)
								</label>
							</div>
			    		</div>
					</div>
